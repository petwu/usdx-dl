      ...
      >
        ...
        <p>
          ...
          <a
            ...
            >yt-dlp</a
          >
          to download the audio and video from YouTube and then applies various AI
          models to split the vocals and music or even transcribe the lyrics and
          generate the
        ...
        <p>
          ...
          <a href="https://usdb.animux.de/" target="_blank" rel="noopener noreferrer"
            >usdb.animux.de</a
          >, login or create an account, search for the song you want to download and
          copy the URL with the <code>id=...</code> parameter, e.g.:
        </p>
        ...
        <p>
          ...
          generate the pitch information and usdx <code>.txt</code> files, which may not
          be as accurate as the USDB source. It is also slower.
        </p>
        ...
        <p>
          ...
          <TabLink id="tab-queue">Queue</TabLink> and ask you to verify and, if
          necessary, edit <Pencil /> the song metadata.
        </p>
        <p>
          You can move songs up <ArrowUp /> or down <ArrowDown /> in the queue to
          prioritize them, or remove <Trash2 /> them if you change your mind. The queue
          is processed in order from top to bottom.
        </p>
        ...
        <p>
          ...
          tab displays all downloaded songs. You can filter them by title or artist,
          play
        ...
        <p>
          The <TabLink id="tab-logs">Output</TabLink> tab shows real-time logs of the
          worker processing the queue. Processing a single song typically takes a few
          minutes, depending on the length of the song and the speed of your computer.
          You can pause <Pause /> or resume <Play /> processing with the button in the
          top left. If a problem occurs, the logs probably contain useful error
          messages.
        </p>
